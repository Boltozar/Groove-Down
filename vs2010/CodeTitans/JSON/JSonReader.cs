...
namespace CodeTitans.JSon
{
    ...
    public sealed class JSonReader : IJSonReader
    {
        ...
        /// </summary>
        private class TokenDataChar : TokenData
        {
            /// <summary>
            /// Init constructor.
            /// </summary>
        ...
        /// </summary>
        private class TokenDataString : TokenData
        {
            /// <summary>
            /// Init constructor.
            /// </summary>
        ...
        /// </summary>
        private class JSonObjectFactory : IObjectFactory
        {
        ...
        /// </summary>
        private class FclObjectFactory : IObjectFactory
        {
            public object CreateArray(List<Object> data)
            {
                return data.ToArray();
